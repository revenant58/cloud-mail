const en = {
    ...
    apiKeyEmpty: 'No API keys found',
    apiKeyCreateTitle: 'Create API Key',
    apiKeyNamePlaceholder: 'Name (e.g. Discord Bot)',
    apiKeyExpirePlaceholder: 'Expiration (optional)',
    apiKeyGenerate: 'Generate Key',
    apiKeyGeneratedTitle: 'API Key Generated',
    apiKeyGeneratedDesc: 'Copy this key now. It will NOT be shown again.',
    apiKeyCopy: 'Copy to Clipboard',
    apiKeyDisable: 'Disable',
    apiKeyEnable: 'Enable',
    apiKeyDeleteConfirm: 'This will permanently delete this API key. Continue?',
